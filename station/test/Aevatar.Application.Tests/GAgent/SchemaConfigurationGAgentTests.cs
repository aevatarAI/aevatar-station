...
public class SchemaConfigurationGAgentTests : AevatarApplicationGrainsTestBase
{
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_WithValidConfigurations_ShouldReturnConfigurations()
    {
        // Arrange
        ...
        // Act
        var result = await grain.GetConfigOptionsAsync<SystemLLMConfigOptions>();
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_EmptyConfiguration_ShouldReturnEmptyOptions()
    {
        // Arrange
        var grainId = Guid.NewGuid().ToString();
        var grain = _clusterClient.GetGrain<ISchemaConfigurationGAgent>(grainId);
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_MultipleCallsSameGrain_ShouldReturnConsistentResults()
    {
        // Arrange
        var grainId = Guid.NewGuid().ToString();
        var grain = _clusterClient.GetGrain<ISchemaConfigurationGAgent>(grainId);
        ...
        // Act
        var result1 = await grain.GetConfigOptionsAsync<SystemLLMConfigOptions>();
        var result2 = await grain.GetConfigOptionsAsync<SystemLLMConfigOptions>();
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_DifferentGrains_ShouldReturnSameConfigurations()
    {
        // Arrange
        ...
        // Act
        var result1 = await grain1.GetConfigOptionsAsync<SystemLLMConfigOptions>();
        var result2 = await grain2.GetConfigOptionsAsync<SystemLLMConfigOptions>();
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_WithValidConfiguration_ShouldLogInformation()
    {
        // Arrange
        var grainId = Guid.NewGuid().ToString();
        var grain = _clusterClient.GetGrain<ISchemaConfigurationGAgent>(grainId);
    ...
    public async Task SchemaConfigurationGAgent_StateOperations_ShouldWork()
    {
        ...
        var config = await grain.GetConfigOptionsAsync<SystemLLMConfigOptions>();
        config.ShouldNotBeNull();
        
        // Test multiple operations to ensure grain state is maintained
        var config2 = await grain.GetConfigOptionsAsync<SystemLLMConfigOptions>();
        config2.ShouldNotBeNull();
    }

    [Fact]
    public async Task GetConfigOptionsAsync_PerformanceTest_ShouldCompleteQuickly()
    {
        // Arrange
        var grainId = Guid.NewGuid().ToString();
        var grain = _clusterClient.GetGrain<ISchemaConfigurationGAgent>(grainId);
    ...
    [Fact]
    public async Task GetConfigOptionsAsync_ConcurrentCalls_ShouldHandleCorrectly()
    {
        // Arrange
        var grainId = Guid.NewGuid().ToString();
        var grain = _clusterClient.GetGrain<ISchemaConfigurationGAgent>(grainId);
        ...
        for (int i = 0; i < 5; i++)
        {
            tasks.Add(grain.GetConfigOptionsAsync<SystemLLMConfigOptions>());
        }
