...
| F012 | K8s Deployment Update Regression Test | ✅ | High | feature/developer-v0.4-dev-merged | c6:c4:e5:e8:c6:4b | - | ✓ | ✓ | Added comprehensive k8s deployment test - covers Host creation, Docker updates, copy operations, log retrieval |
>>>>>>> dev
