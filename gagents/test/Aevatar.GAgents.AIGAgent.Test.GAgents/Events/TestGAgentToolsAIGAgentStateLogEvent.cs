// ABOUTME: This file defines state log events for TestGAgentToolsAIGAgent used in GAgent tool testing
...
[GenerateSerializer]
public class TestGAgentToolsAIGAgentStateLogEvent : StateLogEventBase<TestGAgentToolsAIGAgentStateLogEvent>
{
    [Id(0)] public string? PromptTemplate { get; set; }
    [Id(1)] public string? SystemLLM { get; set; }
    [Id(2)] public string? LLMConfigKey { get; set; }
    [Id(3)] public bool EnableGAgentTools { get; set; }
