...
using Aevatar.GAgents.AIGAgent.Test.GAgents.Events;
using Microsoft.Extensions.Logging;

namespace Aevatar.GAgents.AIGAgent.Test.GAgents;

public interface ITestChatAIGAgent : IAIGAgent, IStateGAgent<TestChatAIGStateBase>
{
    ...
    Task<List<TextToImageResponse>?> GenerateImageAsync(string prompt, TextToImageOption? textToImageOption = null);
    Task TextToImageAsync(string prompt, TextToImageOption? textToImageOption = null);
}

[GenerateSerializer]
public class TestChatAIGStateBase : AIGAgentStateBase
{
    [Id(0)] public List<AIStreamChatContent> ContentList = [];
    [Id(1)] public List<TextToImageResponse> TextToImageResponses = [];
    [Id(2)] public List<ChatMessage> ChatHistory { get; set; } = [];
}

[GenerateSerializer]
public class TestChatAIStateLogEvent : StateLogEventBase<TestChatAIStateLogEvent>;

[GenerateSerializer]
public class AddMessageLogEvent : TestChatAIStateLogEvent
{
    [Id(0)] public AIStreamChatContent Content { get; set; }
}

[GenerateSerializer]
public class TextToImageLogEvent : TestChatAIStateLogEvent
{
...
[GAgent]
public class TestChatAIGAgent : AIGAgentBase<TestChatAIGStateBase, TestChatAIStateLogEvent>, ITestChatAIGAgent
{
    ...
    {
        return Task.FromResult("GAgent for testing chatting with user.");
    }
    ...
    protected override void AIGAgentTransitionState(TestChatAIGStateBase state,
        StateLogEventBase<TestChatAIStateLogEvent> @event)
    {
        switch (@event)
        {
