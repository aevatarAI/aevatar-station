...
public class TestExecutorPublishingGAgent :
    GAgentBase<TestExecutorPublishingGAgentState, TestExecutorPublishingGAgentStateLogEvent>, IPublishingGAgent
{
    ...
    protected override void GAgentTransitionState(TestExecutorPublishingGAgentState state,
        StateLogEventBase<TestExecutorPublishingGAgentStateLogEvent> @event)
    {
