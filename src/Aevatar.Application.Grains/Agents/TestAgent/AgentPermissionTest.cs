...
public class AgentPermissionTest : PermissionGAgentBase<PermissionAgentState, PermissionTestEvent>,IAgentPermissionTest
{
...
public interface IAgentPermissionTest : IStateGAgent<PermissionAgentState>
{
}