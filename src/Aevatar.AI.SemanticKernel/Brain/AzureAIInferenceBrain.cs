...
public class AzureAIInferenceBrain : IBrain
{
    private Kernel _kernel;
    private string _promptTemplate;
    
    private readonly IOptions<ModelConfig> _azureOpenAIConfig;
    ...
    public AzureAIInferenceBrain(IOptions<ModelConfig> modelConfig, IKernelBuilderFactory kernelBuilderFactory, IServiceProvider serviceProvider, ILogger<AzureOpenAIBrain> logger, IOptions<RagConfig> ragConfig)
    {
