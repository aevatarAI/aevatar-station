...
| WorkflowRunRecordGAgent 日志记录优化 | 🚧 | feature/workflow-execution-record-logging-optimization | 42:82:57:47:65:d4 | 开发中：基于原有WorkflowRunRecordGAgent设计进行优化，在保持简洁性和非侵入性的前提下增加event流转追踪、结构化参数记录和agent状态快照功能。已完成简化优化设计文档。 |