...
public class AgentService : ApplicationService, IAgentService
{
    ...
    /// <summary>
    /// Enhances JSON Schema with default values and enum options from DefaultValuesAttribute using base schema
    /// </summary>
    private async Task<string> EnhanceSchemaWithDefaultsFromBase(string baseSchema, Type configurationType)
    {
        try
        {
