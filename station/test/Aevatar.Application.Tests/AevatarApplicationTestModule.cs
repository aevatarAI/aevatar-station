...
public class AevatarApplicationTestModule : AbpModule
{
    ...
    private static IKubernetesClientAdapter CreateMockKubernetesClientAdapter()
    {
        ...
        // 为所有方法提供默认的Mock实现
        mock.Setup(x => x.ListNamespacedPodAsync(It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(new V1PodList());
        mock.Setup(x => x.ListConfigMapAsync(It.IsAny<string>())).ReturnsAsync(new V1ConfigMapList());
        
        // 对ListDeploymentAsync进行特殊处理，返回追踪的deployment列表
        mock.Setup(x => x.ListDeploymentAsync(It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(() => new V1DeploymentList { Items = deployments });
            
        mock.Setup(x => x.ListServiceAsync(It.IsAny<string>())).ReturnsAsync(new V1ServiceList());
        mock.Setup(x => x.ListIngressAsync(It.IsAny<string>())).ReturnsAsync(new V1IngressList());
        mock.Setup(x => x.CreateConfigMapAsync(It.IsAny<V1ConfigMap>(), It.IsAny<string>())).ReturnsAsync(new V1ConfigMap());
        
        // 对CreateDeploymentAsync进行特殊处理，添加deployment到追踪列表
        mock.Setup(x => x.CreateDeploymentAsync(It.IsAny<V1Deployment>(), It.IsAny<string>()))
            .Callback<V1Deployment, string>((deployment, ns) =>
            {
                // 添加deployment到追踪列表
                deployments.Add(deployment);
            })
            .ReturnsAsync((V1Deployment deployment, string ns) => deployment);
            
        mock.Setup(x => x.CreateServiceAsync(It.IsAny<V1Service>(), It.IsAny<string>())).ReturnsAsync(new V1Service());
        mock.Setup(x => x.CreateIngressAsync(It.IsAny<V1Ingress>(), It.IsAny<string>())).ReturnsAsync(new V1Ingress());
        mock.Setup(x => x.DeleteConfigMapAsync(It.IsAny<string>(), It.IsAny<string>())).Returns(Task.CompletedTask);
        
        // 对DeleteDeploymentAsync进行特殊处理，从追踪列表中删除deployment
        mock.Setup(x => x.DeleteDeploymentAsync(It.IsAny<string>(), It.IsAny<string>()))
            .Callback<string, string>((name, ns) =>
            {
        ...
        mock.Setup(x => x.DeleteServiceAsync(It.IsAny<string>(), It.IsAny<string>())).Returns(Task.CompletedTask);
        mock.Setup(x => x.DeleteIngressAsync(It.IsAny<string>(), It.IsAny<string>())).Returns(Task.CompletedTask);
        mock.Setup(x => x.ReadNamespacedDeploymentAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new V1Deployment());
        mock.Setup(x => x.ReplaceNamespacedDeploymentAsync(It.IsAny<V1Deployment>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new V1Deployment());
        mock.Setup(x => x.ReadNamespacedConfigMapAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new V1ConfigMap());
        mock.Setup(x => x.ReplaceNamespacedConfigMapAsync(It.IsAny<V1ConfigMap>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new V1ConfigMap());
        mock.Setup(x => x.ReadNamespacedHorizontalPodAutoscalerAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(new V2HorizontalPodAutoscaler());
        mock.Setup(x => x.CreateNamespacedHorizontalPodAutoscalerAsync(It.IsAny<V2HorizontalPodAutoscaler>(), It.IsAny<string>())).ReturnsAsync(new V2HorizontalPodAutoscaler());
