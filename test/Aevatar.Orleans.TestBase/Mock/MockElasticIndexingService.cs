...
public class MockElasticIndexingService : IIndexingService, ISingletonDependency
{
    ...
    public Task TryCreateTokenUsageIndexAsync(string indexName)
    {
        throw new NotImplementedException();
    }

    public Task SaveTokenUsageAsync(string indexName, List<CQRS.Dto.TokenUsage> tokenUsages)
    {
        throw new NotImplementedException();
    }

    public Task<Tuple<long, List<string>>> QueryTokenUsageAsync(string indexName, string systemLLM, DateTime startTime, DateTime endTime,
        bool statisticsAsHour)
    {
        throw new NotImplementedException();
    }
}