...
public sealed class GAgentToolsIntegrationTest : AevatarAIGAgentTestBase
{
    ...
    public async Task Should_Execute_Complete_GAgent_Tools_Workflow()
    {
        ...
        var chatAgent = await _agentFactory.GetGAgentAsync<ITestChatAIGAgent>(Guid.NewGuid());
    ...
    public async Task Should_Handle_Multiple_Agents_With_Tools()
    {
        ...
        // Arrange & Act
        var agent1 = await _agentFactory.GetGAgentAsync<ITestChatAIGAgent>(Guid.NewGuid());
        ...
        var agent2 = await _agentFactory.GetGAgentAsync<ITestChatAIGAgent>(Guid.NewGuid());
    ...
    public async Task Should_Handle_Concurrent_Tool_Registration()
    {
        ...
        // Arrange & Act
        var tasks = new List<Task<ITestChatAIGAgent>>();
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                var agent = await _agentFactory.GetGAgentAsync<ITestChatAIGAgent>(Guid.NewGuid());
